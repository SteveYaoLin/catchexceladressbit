...
{
    .FUSE_WORDS[0x10] = 0x00000000 // SPEED_LIMIT disable
};
#else
const FUSE_DATA fuse_init =
{
    .FUSE_WORDS[0x10] = 0x00020000 // SPEED_LIMIT disable
};
#endif
...
int main(int argc, char *argv[])
{
    ...
    TRIGGER_SET(TRIGGER_TB_CONNECT_FUSE_CHECK_SPEED_LIMIT_DIS);
    PRINTF("triggered the TRIGGER_TB_CONNECT_FUSE_CHECK_SPEED_LIMIT_DIS");
    wait_delay (1000);
