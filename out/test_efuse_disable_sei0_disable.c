...
{
    .FUSE_WORDS[0x12] = 0x00000000 // SEI0_DISABLE disable
};
#else
const FUSE_DATA fuse_init =
{
    .FUSE_WORDS[0x12] = 0x00020000 // SEI0_DISABLE disable
};
#endif
...
int main(int argc, char *argv[])
{
    ...
    TRIGGER_SET(TRIGGER_TB_CONNECT_FUSE_CHECK_SEI0_DISABLE_DIS);
    PRINTF("triggered the TRIGGER_TB_CONNECT_FUSE_CHECK_SEI0_DISABLE_DIS");
    wait_delay (1000);
